...
public class RoomRobin extends World
{
    ...
    public void act (){
...

        {
            ...
            if (Playable == 4) {
        if(Greenfoot.isKeyDown("down") && Defender.locationY < 700) {
                
                Defender.locationY = Defender.locationY + 3;}
        if (Greenfoot.isKeyDown("up") && Defender.locationY > 0) {
        ...
        if (CanShoot == false) {
            ...
            if (Code.locationX >= Electricity.locationX - 5 && Code.locationX <= Electricity.locationX + 5
                && Code.locationY >= Electricity.locationY - 25 && Code.locationY <= Electricity.locationY + 45) {
    ...
    if (NextBox.click("tap")) {
        ...
        //Write code here to proceed to the next room once the group has decided which room is next.
        //Also, some Texts or Props might have to be deleted upon clicking the next box because Greenfoot acts strange sometimes....
