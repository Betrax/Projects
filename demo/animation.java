...
// USE `animation *WORLD* = new animation(file_path);` THEN `setBackground(*WORLD*.draw(scaleX, scaleY));` for backgrounds.
// USE `animation *OBJECT* = new animation(file_path);` THEN `setImage(*OBJECT*.draw(scaleX, scaleY));` for anything else.
...
{   long static_time = System.currentTimeMillis();
    ...
    public animation(String path)
    {
        ...
        java_file_path = (System.getProperty("user.dir") +"/images/"+ file_path).replaceAll("\\\\", "/"); 
