...
public class Room4saad extends World
{
    ...
    private String textend2 = "You are now officialy a new member of the Universal Standard Code for Information Interchange group.";
    ...
    private String texta = "In this room you will have to solve four different Multiple Choice Questions.";
    private String textb = "Every Multiple Choice Question has only one answer.";
    private String textc = "If you have answered the first question correctly, press the green arrow.";
    private String textd = "Press on the center of the screen to start.";
